...
public class BookJsonTests {
    ...
    void testSerialize() throws Exception {
        ...
        assertThat(json.write(book)).extractingJsonPathStringValue("@.publishingYear").isEqualTo("1973");
    }

    @Test
    void testDeserialize() throws Exception {
        String content = "{\"isbn\":\"1234567890\", \"title\":\"Title\"," +
                "\"author\":\"Author\", \"publishingYear\":\"1973\"}";
